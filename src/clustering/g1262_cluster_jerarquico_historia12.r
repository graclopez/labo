...
PARAM <- list()
PARAM$experimento  <- "CLU1262_Mas_Campos"
...
dataset  <- fread( "./exp/FEH_Comp3_E2_lag3/dataset.csv.gz", stringsAsFactors= TRUE)
...
campos_buenos  <- c( "ctrx_quarter", "cpayroll_trx", "mcaja_ahorro", "mtarjeta_visa_consumo", "ctarjeta_visa_transacciones",
                     "mcuentas_saldo", "mrentabilidad_annual", "mprestamos_personales", "mactivos_margen", "mpasivos_margen",
                     "mpayroll",
                     ...
                     "mpagomiscuentas","m_totaltransac","mpayroll_sobre_edad","m_totaldinero","m_totalprestamos","mr_limitecompra",
                     "m_totaltransac_rank","m_totaldinero_rank","mtarjeta_visa_consumo_rank","m_totalprestamos_rank","mcuentas_saldo_rank",
                     "mpasivos_margen_rank","vm_status01","mactivos_margen_rank","ccaja_seguridad","mr_limitecompra_rank")
