...
dtrain[, dife_mdescomi := suma_mdescuentos - suma_mcomisiones] 
...
dapply[, dife_mdescomi := suma_mdescuentos - suma_mcomisiones] 
...
dtrain[,c("cprestamos_personales","cprestamos_prendarios","cprestamos_hipotecarios",
                    ...
                    "suma_mdescuentos","suma_mcomisiones"):=NULL]
...
for( corte  in  c( 7500, 8000, 8500, 9000, 9500, 10000, 10500, 11000 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/FEComp1/FE_003_",  corte, ".csv"),
           sep=  "," )
}
