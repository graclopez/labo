...
campos_modelo
campos_buenos
View(dataset[foto_mes==202101 & ccajas_transacciones >0,c("ccajas_transacciones","ccajas_otras","ccajas_consultas","ccajas_extracciones","ccajas_depositos")])
...
summary(dataset[foto_mes==202101,mtarjeta_visa_consumo])
summary(dataset[foto_mes==202101,Visa_mconsumototal])

summary(dataset[foto_mes==202103,mtarjeta_visa_consumo])

media <- mean(dataset[foto_mes==202101,mcomisiones])
minimo <- min(dataset[foto_mes==202101,mcomisiones])
maximo <-max(dataset[foto_mes==202101,mcomisiones])
std_mcomisiones =
