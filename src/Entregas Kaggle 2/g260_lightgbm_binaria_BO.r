...
PARAM$experimento  <- "HT_LGBM_Norm_fechas"
...
PARAM$hyperparametertuning$semilla_azar  <- 216617  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
