...
PARAM <- list()
PARAM$experimento  <- "HT_LGBM_BASICO_ENTREGA"
...
PARAM$finalmodel$learning_rate     <-     0.0064877290   #0.0142501265
PARAM$finalmodel$num_iterations    <-    252  #615
PARAM$finalmodel$num_leaves        <-   388  #784
PARAM$finalmodel$min_data_in_leaf  <-   1  #5628
PARAM$finalmodel$feature_fraction  <-    0.3876127272  #0.8382482539
