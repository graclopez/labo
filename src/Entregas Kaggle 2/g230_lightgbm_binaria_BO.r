...
PARAM$experimento  <- "HT_LGBM_FE3"

#PARAM$input$dataset       <- "./datasets/competencia2_2022.csv.gz"
PARAM$input$dataset       <- "./datasets/comp2_FE3_2022.csv.gz"
...
# ya tengo las transformaciones en el dataset de entrada
# Aca saco las columnas que no quiero usar
