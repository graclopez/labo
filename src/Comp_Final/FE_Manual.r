...
PARAM  <- list()
PARAM$experimento  <- "EXP_COL_PASO1"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "EXP_COL_PASO2"

PARAM$exp_input  <- "EXP_COL_PASO1"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "EXP_COL_PASO3"

PARAM$exp_input  <- "EXP_COL_PASO2"
