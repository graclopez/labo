...
PARAM  <- list()
PARAM$experimento <- "FINAL_TEST_01_TS_FT_15meses_SINRF_SinCan"

PARAM$exp_input  <- "FINAL_01_FEH_lag3_Tend6_RF_SinCan"


# VERSION PARA TEST. USO LOS MISMOS MESES QUE EN COMP 3 
# CON LA ESTRATEGIA DE LA COMP 4 
# LUEGO SUBO A KAGGLE 3 PARA VERFICAR
